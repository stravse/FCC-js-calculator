...
function Mainpad(props) {
    ...
    return (
        <div className="main-number-container">
            ...
            <button id="divide" onClick={props.operator} value="/" className="btn-operator" >/</button>
            <button id="multiply" onClick={props.operator} value="*" className="btn-operator" >*</button>
            ...
            <button id="subtract" onClick={props.operator} value="-" className="btn-operator" >-</button>
            ...
            <button id="add" onClick={props.operator} value="+" className="btn-operator" >+</button>
            ...
            <button id="equals" onClick={props.doEval} className="span-two-row btn-operator" value="=" >=</button>
